...
🔗[Ссылка на задание 1](http://greatcode.ru/lesson_1.1.1.html). </br>
🔗[Ссылка на задание 1](http://greatcode.ru/lesson_1.1.2.html). </br>
...
🔗[ Ссылка на задание 2](https://greatcode.ru/lesson_2.1.1.html). </br>
Дальше придется чуть поднапрячься </br>
🔗[ Ссылка на задание 2](https://greatcode.ru/lesson_2.1..html).  </br>
🔗[Ссылка на задание 2](https://greatcode.ru/lesson_2.1.2.html). </br>
🛑 в этом задании есть упорядоченный список с римскими цифрами и список который начинается с 10 буквы всю информацию можете найти в книге [`htmlbook.ru` в поиске `ol и ul`]
